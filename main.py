...
def main():
    ...
    prod_results = evaluate_pipeline(search, reranker, latencies)

    # Move/copy reports to reports/
    ...
    # Step 3: Comparison
    print("\n[STEP 3] Comparison (Baseline vs Production)")
    print("-" * 55)
    ...
    if os.path.exists(naive_path) and os.path.exists(prod_path):
        ...
        for m in ["faithfulness", "answer_relevancy", "context_precision", "context_recall"]:
            ...
            d = p - n
            status = "[PASS]" if p >= 0.75 else "[OK]"
            print(f"{status} {m:<20} {n:>8.4f} {p:>12.4f} {d:>+8.4f}")

    elapsed = time.time() - start
    print(f"\nTotal Pipeline Execution Time: {elapsed:.1f}s")
    print("\nNext steps:")
    print("  1. Cap nhat analysis/failure_analysis.md")
    print("  2. Cap nhat analysis/group_report.md")
    print("  3. Viet analysis/reflections/reflection_HoangManhDung.md")
    print("  4. Kiem tra dinh dang: python check_lab.py")
